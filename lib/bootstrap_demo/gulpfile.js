...
gulp.task('copy', function() {
    gulp.src(['bower_components/bootstrap_demo/dist/**/*', '!**/npm.js', '!**/bootstrap_demo-theme.*', '!**/*.map'])
        .pipe(gulp.dest('vendor/bootstrap_demo'))

    gulp.src(['bower_components/bootstrap_demo-social/*.css', 'bower_components/bootstrap_demo-social/*.less', 'bower_components/bootstrap_demo-social/*.scss'])
        .pipe(gulp.dest('vendor/bootstrap_demo-social'))

    gulp.src(['bower_components/datatables/media/**/*'])
        .pipe(gulp.dest('vendor/datatables'))

    gulp.src(['bower_components/datatables-plugins/integration/bootstrap_demo/3/*'])
