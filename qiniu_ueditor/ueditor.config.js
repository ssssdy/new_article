...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"http://up-z2.qiniu.com/"             //图片上传提交地址
        ,imagePath:"http://orc8koj7r.bkt.clouddn.com/"     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,imageFieldName:"file"                      //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        //,compressSide:0                           //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        //,maxImageSideLength:900                   //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ,savePath: ['ssssdy']    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        //附件上传配置区
        ,fileUrl:"http://up-z2.qiniu.com/"              //附件上传提交地址
        ,filePath:"http://orc8koj7r.bkt.clouddn.com/"                  //附件修正地址，同imagePath
        ...
        ,imageManagerPath:"http://orc8koj7r.bkt.clouddn.com/"     //图片修正地址，同imagePath
