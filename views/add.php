...
//                echo $_SESSION['role_id'];
    ...
    <div class="menu">
        ...
        switch ($_SESSION['role_id']) {
            case "1":
                echo "<ul><li><a href='../views/index.php'>文章首页</a></li>
                        <li><a href='../views/add.php'>添加文章</a></li></ul>";
                break;
            case "2":
                echo "<ul><li><a href='../views/index.php'>文章首页</a></li>
                        <li><a href='../views/add.php'>添加文章</a></li>
                        <li><a href='../views/handle.php'>图片上传</a></li>
                        <li><a href='../views/add_tag.php'>添加文章分类</a></li>
                        <li><a href='../views/addEidtor.php'>变更用户权限</a></li></ul>";
                break;
            case "3":
                echo "<ul><li><a href='../views/index.php'>文章首页</a></li>
                        <li><a href='../views/add.php'>添加文章</a></li>
                        <li><a href='../views/handle.php'>图片上传</a></li>
                        <li><a href='../views/add_tag.php'>添加文章分类</a></li>
                        <li><a href='../views/addEidtor.php'>变更用户权限</a></li>
                        <li><a href='../views/addAdmin.php'>添加管理员</a></li></ul>";
                break;
        }
        ?>
    </div>
    <div class="content">
        <center>
            <?php
            require("../static/globle_helper.php");
            ...
            ?>
            <h3>发布文章</h3>
            <form action="../controllers/action.php?action=add" method="post">
                <table width="800">
                    <tr>
